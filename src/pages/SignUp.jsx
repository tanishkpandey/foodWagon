  ...
  return (
    <div>
      <div className="p-[2rem] bg-[#FFF5E2]">
        <div class="relative p-[2rem] mx-auto w-[450px] m-10 flex flex-col bg-white text-gray-700 bg-transparent rounded-xl bg-clip-border shadow-xl">
          <h4 class="block   text-2xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
            SignUp
          </h4>
          <p class="block mt-1   text-base antialiased font-normal leading-relaxed text-gray-700">
            Nice to meet you! <br /> Enter your details to create an account.
          </p>
          <form class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
            ...
            <div class="inline-flex items-center">
              ...
              <label
                ...
                htmlFor="remember"
              >
                <p class="flex items-center   text-sm antialiased font-normal leading-normal text-gray-700">
                  I agree the
                  <a
                    href="#"
            ...
            <p class="block mt-4  text-base antialiased font-normal leading-relaxed text-center text-gray-700">
              ...
              <NavLink to="/login">
                <a href="#" class="font-medium text-[#F17228]  ml-3">
                  Login
                </a>
              </NavLink>
            </p>
